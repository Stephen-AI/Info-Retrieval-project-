...
public abstract class Document {
    ...
    /**
     * ADDED:
     * The location of the next token. Is incremented on every successful call to next token
     */
    protected  int currentLocation = 0;
    /**
     * ADDED:
     * stores the locations of all occurences of a token
     */
    protected Map<String, List<Integer>> tokenLocations;
    /**
