...
./zip_shell.sh -p $PREFIX -m PageRankInvertedIndex.java -t temp -w 0.0 -r $CRAWL_DIR
cat $TEMP_TRACE >> $RETRIEVE_TRACE
./zip_shell.sh -p $PREFIX -m PageRankInvertedIndex.java -t temp -w 5.0 -r $CRAWL_DIR
cat $TEMP_TRACE >> $RETRIEVE_TRACE
./zip_shell.sh -p $PREFIX -m PageRankInvertedIndex.java -t temp -w 10.0 -r $CRAWL_DIR
cat $TEMP_TRACE >> $RETRIEVE_TRACE
rm $TEMP_TRACE
